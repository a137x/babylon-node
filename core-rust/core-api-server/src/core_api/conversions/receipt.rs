...
pub fn to_api_next_epoch(
    ...
    let next_epoch = models::NextEpoch {
        ...
        validators: validator_set
            ...
            .collect::<Result<_, _>>()?,
        significant_protocol_update_readiness: Some(significant_protocol_update_readiness
            .into_iter()
            .map(|(readiness_signal_name, signalled_stake)| models::SignificantProtocolUpdateReadinessEntry {
